...
// adding the variables in the array
- (void)pushVariable:(NSString *)variable
{
    [self.operandStack addObject:variable];
}

// adding the operand in the array
...
+ (NSMutableSet *)variablesUsedInProgram:(id)program
{
    ...
    if ([program containsObject:@"x"])
         variablesSetUsedInProgram=[variablesSetUsedInProgram initWithObjects:@"x", nil];
    if ([program containsObject:@"y"])
        variablesSetUsedInProgram=[variablesSetUsedInProgram initWithObjects:@"y", nil];
    if ([program containsObject:@"foo"])
        variablesSetUsedInProgram=[variablesSetUsedInProgram initWithObjects:@"foo", nil];
